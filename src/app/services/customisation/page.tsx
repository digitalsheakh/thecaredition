        ...
        <div className="container mx-auto px-8">
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-900 p-6 rounded-lg border border-gray-800 hover:border-red-600 transition-colors duration-300">
                <h4 className="text-lg font-bold text-white mb-3 font-rajdhani">Bluetooth & Connectivity</h4>
                <p className="text-gray-300 font-rajdhani text-sm leading-relaxed">Hands-free calling, wireless charging, and smartphone integration</p>
              </div>
            </div>
