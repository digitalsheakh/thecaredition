...
const InCarEntertainment = () => {
 ...
 <div>
         ...
         <div className='space-y-4 p-4'>
           <h1 className='text-4xl font-bold text-white mb-4'>In-Car Entertainment</h1>
           <div>
 ...
 <h1 className='text-4xl font-bold text-white mb-4'>Need your in-car entertainment system upgraded?</h1>
...
export default InCarEntertainment