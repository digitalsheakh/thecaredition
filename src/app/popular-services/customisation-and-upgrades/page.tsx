...
const CustomisationAndUpgrades = () => {
  return (
 ...
 <div>
         ...
         <div className='space-y-4 p-4'>
           <h1 className='text-4xl font-bold text-white mb-4'>Customisation & Upgrades</h1>
           <div>
 ...
 <h1 className='text-4xl font-bold text-white mb-4'>Need your car customised?</h1>
...
export default CustomisationAndUpgrades