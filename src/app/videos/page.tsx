          ...
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              ...
              <a 
                ...
                className="group bg-gray-900 rounded-lg overflow-hidden border border-gray-800 hover:border-red-600 transition-all duration-300"
              >
                ...
                <div className="p-4">
                  <h4 className="text-white font-rajdhani font-bold text-base mb-2 group-hover:text-red-600 transition-colors line-clamp-2">EP 1: Workshop Stories & Automotive Insights</h4>
                  <div className="flex items-center justify-between mt-3">
                    <span className="text-red-600 font-rajdhani text-xs font-bold uppercase flex items-center">
              ...
              >
                ...
                <div className="p-4">
                  <h4 className="text-white font-rajdhani font-bold text-base mb-2 group-hover:text-red-600 transition-colors line-clamp-2">EP 2: Behind The Scenes at The Car Edition</h4>
                  <div className="flex items-center justify-between mt-3">
                    <span className="text-red-600 font-rajdhani text-xs font-bold uppercase flex items-center">
                      <FaYoutube className="mr-1" />
                      Listen Now
              ...
              >
                ...
                <div className="p-4">
                  <h4 className="text-white font-rajdhani font-bold text-base mb-2 group-hover:text-red-600 transition-colors line-clamp-2">EP 3: Diagnostic Deep Dive & Tech Talk</h4>
                  <div className="flex items-center justify-between mt-3">
                    <span className="text-red-600 font-rajdhani text-xs font-bold uppercase flex items-center">
                      <FaYoutube className="mr-1" />
                      Listen Now
              ...
              >
                ...
                <div className="p-4">
                  <h4 className="text-white font-rajdhani font-bold text-base mb-2 group-hover:text-red-600 transition-colors line-clamp-2">EP 4: Expert Tips & Common Car Issues</h4>
                  <div className="flex items-center justify-between mt-3">
                    <span className="text-red-600 font-rajdhani text-xs font-bold uppercase flex items-center">
                      <FaYoutube className="mr-1" />
                      Listen Now
            ...
            <div className="text-center">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-8 py-4 font-bold font-orbitron uppercase tracking-wider transition-all duration-300 rounded-lg"
              >
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex items-center justify-center gap-4 text-sm">
                        <span className="text-gray-400 font-rajdhani">Watch on YouTube</span>
