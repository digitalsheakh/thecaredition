          ...
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              <button
                ...
                className={`w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm font-rajdhani ${activeTab === "tutorial" ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
                Tutorial
              </button>
              <button
                onClick={() => setActiveTab("profile")}
                className={`w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm font-rajdhani ${activeTab === "profile" ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
                Profile
              </button>
              <button
                onClick={() => setActiveTab("password")}
                className={`w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm font-rajdhani ${activeTab === "password" ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
                Password
              </button>
            </nav>
              ...
              <form onSubmit={handleProfileSubmit(onSubmitProfile)} className="space-y-8">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border-2 border-gray-200 shadow-sm">
                  <div className="flex items-center justify-center mb-6">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-0 right-0 bg-red-500 rounded-full p-2 shadow-lg">
                  ...
                  {isEditMode && (
                    <div className="mt-4">
                      ...
                      <input
                        ...
                        className="block w-full text-sm text-gray-700 file:mr-4 file:py-3 file:px-6 file:rounded-lg file:border-0 file:text-sm file:font-bold file:bg-red-500 file:text-white hover:file:bg-red-600 file:transition-all file:duration-200 file:shadow-md hover:file:shadow-lg cursor-pointer font-rajdhani"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div>
                    ...
                    />
                    {profileErrors.name && (
                      <p className="mt-2 text-sm text-red-600 font-rajdhani">{profileErrors.name.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-4 bg-white border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-gray-900 placeholder-gray-500 transition-all duration-200 font-rajdhani text-base ${
                        !isEditMode ? "bg-gray-50 cursor-not-allowed" : ""
                      } ${profileErrors.mobile ? "border-red-500" : "border-gray-300"}`}
                      placeholder="Enter your mobile number"
                    />
                    {profileErrors.mobile && (
                      <p className="mt-2 text-sm text-red-600 font-rajdhani">{profileErrors.mobile.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  />
                  {profileErrors.email && (
                    <p className="mt-2 text-sm text-red-600 font-rajdhani">{profileErrors.email.message}</p>
                  )}
                </div>
                ...
                {isEditMode && (
                  <div className="flex justify-end pt-6 border-t border-gray-200">
                    <button
                      ...
                      className="inline-flex items-center px-8 py-4 text-base font-bold rounded-lg text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 shadow-lg transition-all duration-200 ease-in-out hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 font-rajdhani uppercase tracking-wide disabled:opacity-50"
                    >
                      {loadingProfile ? (
                        <>
              ...
              <form onSubmit={handlePasswordSubmit(onSubmitPassword)} className="space-y-6 max-w-md">
                <div>
                  ...
                  {passwordErrors.currentPassword && (
                    <p className="mt-2 text-sm text-red-600 font-rajdhani">{passwordErrors.currentPassword.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {passwordErrors.newPassword && (
                    <p className="mt-2 text-sm text-red-600 font-rajdhani">{passwordErrors.newPassword.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {passwordErrors.confirmPassword && (
                    <p className="mt-2 text-sm text-red-600 font-rajdhani">{passwordErrors.confirmPassword.message}</p>
                  )}
                </div>
