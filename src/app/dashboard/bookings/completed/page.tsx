    ...
    },
    {
      ...
      accessor: (booking) => (
        <div className="py-3 text-center">
          <span className="inline-flex px-4 py-2 text-sm font-bold rounded-lg font-rajdhani uppercase tracking-wide bg-green-50 text-green-700 shadow-sm">
            {booking.status}
          </span>
        </div>
      ),
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200">
      ...
      <div className="px-6 py-6 border-b border-gray-200 bg-gradient-to-r from-red-50 to-red-100/50">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 font-orbitron uppercase tracking-wider">Completed Services</h1>
            <p className="text-sm text-gray-600 mt-2 font-rajdhani">View and manage completed service bookings</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        <SearchInput
          ...
          placeholder="Search completed services by customer, vehicle, or service..."
        />
