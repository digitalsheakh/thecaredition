  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative" style={{backgroundImage: 'url(/images/logos/background-1.jpg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md bg-gray-900/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-red-600/30"
      >
        {/* Header with Logo */}
        <div className="bg-black/50 p-8 text-center border-b border-red-600/20">
          <Link href="/" className="inline-block">
            <div className="mx-auto h-20 w-20 bg-red-600 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div className="p-8">
          {error && (
            <motion.div
              ...
              className="mb-6 p-4 bg-red-900/50 text-red-300 rounded-lg text-sm border border-red-500/30 font-rajdhani"
            >
              {error}
            </motion.div>
          )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                {errors.email && (
                  <p className="mt-2 text-sm text-red-400 font-rajdhani">{errors.email.message}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                {errors.password && (
                  <p className="mt-2 text-sm text-red-400 font-rajdhani">{errors.password.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-red-400 hover:text-red-300 font-rajdhani">
                  Forgot password?
                </Link>
              </div>
            </div>
